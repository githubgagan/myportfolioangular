...
export class PortfolioComponent implements OnInit {
  ...
  @ViewChild('portfolioHeader',{static: false}) portfolioHeaderRef: ElementRef;
  @ViewChild('portfolioArea' ,{static: false}) portfolioAreaRef: ElementRef;
  @ViewChild('portfolioSelectionArea' ,{static: false}) portfolioSelectionAreaRef: ElementRef;
